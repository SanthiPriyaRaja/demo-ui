              ...
              <div className="px-6 py-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                    ...
                    <div className="text-sm text-blue-700 font-medium">Total Tenants</div>
                  </div>
                  <div className="text-center p-4 bg-gradient-to-br from-green-50 to-green-100 rounded-xl">
                    <div className="text-3xl font-bold text-green-600 mb-1">
                      {leadCounts.total}
                    </div>
                    <div className="text-sm text-green-700 font-medium">Total Leads</div>
                  </div>
                  <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl">
                    <div className="text-3xl font-bold text-purple-600 mb-1">
                      {leadCounts.converted}
                    </div>
                    <div className="text-sm text-purple-700 font-medium">Converted Leads</div>
                  </div>
